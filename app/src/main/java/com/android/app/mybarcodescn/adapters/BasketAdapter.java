...
public class BasketAdapter extends BaseAdapter implements
    ...
    public BasketAdapter(Context context, ArrayList<ProductDetails> products) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            myRow = new MyRow();
            convertView = mInflater.inflate(R.layout.row_activity_consumer_basket, parent, false);
            myRow.ivProdPic = (ImageView) convertView.findViewById(R.id.ivProdPic);
            myRow.tvName = (TextView) convertView.findViewById(R.id.tvName);
            myRow.tvSize = (TextView) convertView.findViewById(R.id.tvSize);
            myRow.tvSelectedount = (TextView) convertView.findViewById(R.id.tvSelectedCount);

            convertView.setTag(myRow);
        } else {
            myRow = (MyRow) convertView.getTag();
        }
        myRow.ivProdPic.setImageBitmap(getItem(position).getProduct_photo());
        myRow.tvName.setText(getItem(position).getName());
        myRow.tvSize.setText(String.valueOf(getItem(position).getSize()));
        myRow.tvSelectedount.setText(String.valueOf(getItem(position).getmSelectedCount()));
    ...
    private class MyRow {
        ...
        private TextView tvSelectedount;
    }
